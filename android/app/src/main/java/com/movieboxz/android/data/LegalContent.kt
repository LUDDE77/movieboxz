...
/**
 * In-app Terms of Service and Privacy Policy — ported verbatim from the iOS
 * app (LegalContent.swift) so both platforms show the same text. Shown from
 * Settings and linked from the first-run welcome. Nothing needs to be hosted.
 */
object LegalContent {
    const val lastUpdated = "July 2026"
    const val supportEmail = "support@movieboxz.com"
